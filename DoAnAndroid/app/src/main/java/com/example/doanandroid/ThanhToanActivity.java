...
public class ThanhToanActivity extends AppCompatActivity {
    ...
    EditText edtDiaChiNhanHang;
    ImageView imageviewThoat;
    TextView edtHoTenNguoiNhan,edtTongTien,edtSoDienThoaiNguoiNhan;
                                        ...
                                        public void onResponse(Call<String> call, Response<String> response) {
                                            if (response.body() != null) {
                                                ...
                                                if (response.body().toString().contains("Success")) {
                                                    ...
                                                    finish();
                                                    startActivity(new Intent(ThanhToanActivity.this,DatHangThanhCongActivity.class));
                                                }
                                                else
    ...
    private void AnhXa() {
        ...
        imageviewThoat = findViewById(R.id.imageviewThoat);
    }
